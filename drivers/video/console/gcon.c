/*
 *  linux/drivers/video/gcon.c -- A console driver for PAPER
 *
 *  To be used on platforms with PAPER integrated
 */
...
const struct consw gcon = {
	...
	.con_switch = gcon_switch, //empty, redraw
	.con_blank = gcon_blank, //TODO
	.con_font_set = gcon_font_set, //empty
